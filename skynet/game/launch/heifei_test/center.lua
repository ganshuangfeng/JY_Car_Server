...
local configs =
{
	...
	stat_sql_top_count = 5,	-- 统计性能最差语句 top 条数
	...
	--- 数据库数据延迟更新的时间 延迟
	common_merge_push_lib_debug_delay = 5,
...
local services =
{
	...
	{	-- 等级中心
		launch = "level_center_service",
		deploy = {level_center_service="node_1"},
	},
	{	-- 资产折扣中心
	...
	{	-- 捕鱼
		launch = "fish_qys_match_center_service/fish_qys_match_center_service",
		deploy = {fish_qys_match_center_service="node_1"},
	},
	{	-- 捕鱼
	...
	{	-- 捕鱼3d
		launch = "fishing_3d_game_center_service/fishing_3d_game_center_service",
		deploy = {fishing_3d_game_center_service="node_1"},
	},
	{	-- 捕鱼子弹排名比赛
		launch = "bullet_rank_match_center_service/bullet_rank_match_center_service",
		deploy = {bullet_rank_match_center_service="node_1"},
	},
	{	-- 冠名赛辅助服务
