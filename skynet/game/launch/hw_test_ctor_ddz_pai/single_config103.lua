...
--logger = "./logs/ddz_ctor_node_103.log"
--daemon = "./logs/ddz_ctor_node_103.pid"

debug_file = "./debug_ddz_ctor_node_103.log"
debug_file_size = 10	-- 日志文件大小（单位：MB）：超过此大小即分文件

start = _dir_names[1] .. "/single_main"	-- main script

my_node_name="node_103"
...
tuoguan_test_node = "node_103"
plyer_agent_node = "node_103"
