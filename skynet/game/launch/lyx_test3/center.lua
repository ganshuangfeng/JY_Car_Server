...
-- 商城服务器
local shoping_server = "http://mall-webapp-user.jyhd919.cn"
...
local nodes = 
{
	...
	game = 
	{
		...
		-- 管理控制台端口：管理服务状态、关机
		admin_console_port = 23011,

		-- skynet 调试控制台端口
		debug_console_port = 23012,
	...
	data = 
	{
		...
		-- 管理控制台端口：管理服务状态、关机
		admin_console_port = 23021,

		-- skynet 调试控制台端口
		debug_console_port = 23022,
	},
	...
	gate = 
	{
		...
		-- 管理控制台端口：管理服务状态、关机
		admin_console_port = 23031,

		-- skynet 调试控制台端口
		debug_console_port = 23032,
	},
}
