...
local configs = 
{
	...
	mysql_dbname = "yy_203_t1",
	mysql_port = 23456,
	mysql_user = "jy",
	mysql_pwd = "123456",


	debug_player_prefix = "YT1_",

	-- skynet 调试控制台端口
	debug_console_port = 7113,

	free_tuoguan_count = 1000,

	tuoguan_max_count = 1500,
	...
	monitor_recieve_email = "83046971@qq.com,liangpai@163.com",
	enable_monitor = true,
