...
-- 全局配置说明：
--	▲ 共用的配置已挪到这里
--	▲ 自己的 center.lua 配置名相同 则会覆盖这里的
--	▲ 如果自己的 center.lua 中相应值要强制设为 nil， 则配置值为 "__nil__" ，例如：
--		cpl_master_keycode = "__nil__"
--
local configs =
{
...
local services =
{
	...
	{	-- 
		launch = "timer_box_center_service/timer_box_center_service",
		deploy = {timer_box_center_service="node_1"},
	},
	{	-- 登录
	...
	{	-- 赛车游戏 策划配置中心 服务
		launch = "driver_cehua_config_center_service/driver_cehua_config_center_service",
		deploy = {driver_cehua_config_center_service="node_1"},
	},
	{	-- 车升级 中心服务
		launch = "car_upgrade_center/car_upgrade_center",
		deploy = {car_upgrade_center="node_1"},
	},
	{	-- 段位赛 数据中心服务
		launch = "duanwei_data_center/duanwei_data_center",
		deploy = {duanwei_data_center="node_1"},
	},
