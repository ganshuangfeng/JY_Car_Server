...
local C = basefunc.create_hot_class("road_play_again" )
C.msg_deal = {}
...
function C.msg_deal:on_stay_road( _effect_data , _game_data , _type_id , _gl , _other_data )
	...
	_effect_data[#_effect_data + 1] = { effect = PROTECT.effect_type.play_again , tar_seat = _game_data.my_seat , value = 1 , gl = _gl }
