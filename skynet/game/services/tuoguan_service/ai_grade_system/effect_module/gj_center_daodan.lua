...
local C = basefunc.create_hot_class("gj_center_daodan" )
C.msg_deal = {}
...
function C.msg_deal:on_stay_road( _effect_data , _game_data , _type_id , _gl ,_other_data)
	...
	print("xxxx-------------effect_module_gj_center_daodan____on_stay_road")

	local effect_value = self.add_value_bfb /100 * award_num * _game_data[_game_data.enemy_seat].car_base_at
