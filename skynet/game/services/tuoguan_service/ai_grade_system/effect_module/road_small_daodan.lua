...
local C = basefunc.create_hot_class("road_small_daodan" )
C.msg_deal = {}
...
---- 当 获得这个路上奖励
function C.msg_deal:on_stay_road( _effect_data , _game_data , _type_id , _gl )
	...
	print("xxxx-------------effect_module_road_small_daodan____on_stay_road")
	...
	local effect_value = self.add_value_bfb / 100 * award_num * _game_data[_game_data.enemy_seat].car_max_hp
