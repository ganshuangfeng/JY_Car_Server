...
) ENGINE = InnoDB AUTO_INCREMENT = 258 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家财物日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `admin_op_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 344 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '管理员操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for admin_webapi_log
-- ----------------------------
DROP TABLE IF EXISTS `admin_webapi_log`;
CREATE TABLE `admin_webapi_log`  (
  `log_id` int(11) NOT NULL AUTO_INCREMENT,
  `op_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人',
  `op_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `launch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '启动配置',
  `api` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '执行的api名字',
  `params` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '参数',
  `succ` int(11) NULL DEFAULT NULL COMMENT '是否成功： 1 成功； 0 失败。',
  `result` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '操作结果',
  PRIMARY KEY (`log_id`) USING BTREE,
  INDEX `op_user`(`op_user`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 217 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '记录后台 api 操作日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `click_like_advise`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3544 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `common_lottery_award_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 225532 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for cpl_backup_data
-- ----------------------------
DROP TABLE IF EXISTS `cpl_backup_data`;
CREATE TABLE `cpl_backup_data`  (
  `cpl_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'cpl名字，比如： pceggs,xianwan',
  `backup_id` int(11) NOT NULL COMMENT '批次id',
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  ...
  PRIMARY KEY (`cpl_name`, `backup_id`, `id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for cpl_backup_info
-- ----------------------------
DROP TABLE IF EXISTS `cpl_backup_info`;
CREATE TABLE `cpl_backup_info`  (
  `cpl_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'cpl名字，比如： pceggs,xianwan',
  `backup_id` int(11) NOT NULL COMMENT '备份id',
  `systype` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ios/android',
  `platform` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '平台',
  `user_numb` int(11) NULL DEFAULT NULL COMMENT '备份用户数量',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '备份时间',
  PRIMARY KEY (`cpl_name`, `backup_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for cpl_dandanzhuan_data
-- ----------------------------
DROP TABLE IF EXISTS `cpl_dandanzhuan_data`;
CREATE TABLE `cpl_dandanzhuan_data`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `ddz_round_count` int(255) NULL DEFAULT NULL COMMENT '斗地主局数',
  `device_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '设备id',
  `payment` int(255) NULL DEFAULT 0 COMMENT '充值，人民币，分',
...
) ENGINE = InnoDB AUTO_INCREMENT = 117 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'cpl变量手工修改日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for cpl_wqp_pceggs_data
-- ----------------------------
DROP TABLE IF EXISTS `cpl_wqp_pceggs_data`;
CREATE TABLE `cpl_wqp_pceggs_data`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `ddz_round_count` int(255) NULL DEFAULT NULL COMMENT '斗地主局数',
  `device_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '设备id',
  `payment` int(255) NULL DEFAULT 0 COMMENT '充值，人民币，分',
...
-- ----------------------------
-- Table structure for cpl_wqp_xianwan_data
-- ----------------------------
DROP TABLE IF EXISTS `cpl_wqp_xianwan_data`;
CREATE TABLE `cpl_wqp_xianwan_data`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `ddz_round_count` int(255) NULL DEFAULT NULL COMMENT '斗地主局数',
  `device_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '设备id',
  `payment` int(255) NULL DEFAULT 0 COMMENT '充值，人民币，分',
...
CREATE TABLE `emails_admin_opt_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 259146 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `emails_every`  (
  ...
  `market_channel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
CREATE TABLE `emails_opt_log`  (
  ...
  `time` datetime(6) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14575358 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for fish_caijin_data
-- ----------------------------
DROP TABLE IF EXISTS `fish_caijin_data`;
CREATE TABLE `fish_caijin_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '玩家id',
  `game_id` int(11) NOT NULL COMMENT '场次id',
  `lottery_num` int(11) NOT NULL COMMENT '抽奖次数',
  `lottery_type` int(11) NOT NULL COMMENT '抽奖类型',
  `lottery_time` bigint(255) NOT NULL COMMENT '抽奖时间',
  `score` bigint(255) NOT NULL COMMENT '积分',
  `kill_num` bigint(255) NOT NULL COMMENT '杀鱼数量',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4950969 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 42977100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `fish_game_player_wave_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key`(`player_id`, `game_id`, `pao_lv`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42976031 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 25934746 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `freestyle_activity_player_log`  (
  ...
  `time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2518850 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 162532928 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家比赛日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `friendgame_player_history`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `records` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `game_profit_cycle_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23445570 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `game_profit_statistics`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 605 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for gm_user_list
-- ----------------------------
DROP TABLE IF EXISTS `gm_user_list`;
CREATE TABLE `gm_user_list`  (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `real_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `op_date` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for guess_apple_period_log
-- ----------------------------
DROP TABLE IF EXISTS `guess_apple_period_log`;
CREATE TABLE `guess_apple_period_log`  (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `period_id` int(50) NULL DEFAULT NULL COMMENT '猜苹果的周期id',
  `bet_1` int(50) NULL DEFAULT NULL COMMENT '左边的总下注',
  `bet_2` int(50) NULL DEFAULT NULL COMMENT '中间的总下注',
  `bet_3` int(50) NULL DEFAULT NULL COMMENT '右边的总下注',
  `bet_total` int(50) NULL DEFAULT NULL COMMENT '总共的下注',
  `kaijiang_pos` tinyint(10) NULL DEFAULT NULL COMMENT '开奖的位置（1左，2平，3右）',
  `is_gold_coin` tinyint(10) NULL DEFAULT NULL COMMENT '是否是金元宝',
  `kaijiang_award` int(50) NULL DEFAULT NULL COMMENT '开奖反的钱',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 113201 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for guess_apple_player_auto_bet_data
-- ----------------------------
DROP TABLE IF EXISTS `guess_apple_player_auto_bet_data`;
CREATE TABLE `guess_apple_player_auto_bet_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `bet_1` int(50) NULL DEFAULT NULL COMMENT '左边下注',
  `bet_2` int(50) NULL DEFAULT NULL COMMENT '中间下注',
  `bet_3` int(50) NULL DEFAULT NULL COMMENT '右边下注',
  `remain_num` int(50) NULL DEFAULT NULL COMMENT '剩余次数',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for guess_apple_player_log
-- ----------------------------
DROP TABLE IF EXISTS `guess_apple_player_log`;
CREATE TABLE `guess_apple_player_log`  (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `period_id` int(50) NULL DEFAULT NULL COMMENT '周期id',
  `bet_1` int(50) NULL DEFAULT NULL COMMENT '左边的下注',
  `bet_2` int(50) NULL DEFAULT NULL COMMENT '中间的下注',
  `bet_3` int(50) NULL DEFAULT NULL COMMENT '右边的下注',
  `bet_total` int(50) NULL DEFAULT NULL COMMENT '总下注',
  `kaijiang_pos` tinyint(10) NULL DEFAULT NULL COMMENT '开奖位置',
  `is_gold_coin` tinyint(10) NULL DEFAULT NULL COMMENT '是否是金元宝',
  `kaijiang_award` int(50) NULL DEFAULT NULL COMMENT '得奖值',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 121769 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for guess_apple_water_pool_data
-- ----------------------------
DROP TABLE IF EXISTS `guess_apple_water_pool_data`;
CREATE TABLE `guess_apple_water_pool_data`  (
  `total_water_value` bigint(50) NULL DEFAULT NULL COMMENT '水池的总盈亏（赢为正，输为负）',
  `total_bet_player_num` int(50) NULL DEFAULT NULL COMMENT '总的下注人次(一个人下两个项目就是两次)，写日志点后清掉',
  `total_game_num` smallint(20) NULL DEFAULT NULL COMMENT '总的游戏次数'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for guess_apple_water_pool_log
-- ----------------------------
DROP TABLE IF EXISTS `guess_apple_water_pool_log`;
CREATE TABLE `guess_apple_water_pool_log`  (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `total_water_value` bigint(50) NULL DEFAULT NULL COMMENT '总的水池值',
  `total_bet_player_num` int(50) NULL DEFAULT NULL COMMENT '总的下注人次',
  `total_game_num` smallint(20) NULL DEFAULT NULL COMMENT '总的游戏次数',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22641 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `jykp_data_analyze`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 677265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `jykp_data_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 480826 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 114442954 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家比赛日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `naming_match_rank`  (
  ...
  `rank` int(10) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 139522 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '比赛场次日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_ddz_nor_race_player_log`  (
  ...
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE,
  INDEX `player_id`(`player_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 164644820 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_gobang_nor_race_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 98219 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_lhd_nor_race_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45278 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_mj_xzdd_race_player_log`  (
  ...
  `pai_info` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38484829 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `nor_pdk_nor_race_player_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12974725 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for npca_active_data
-- ----------------------------
DROP TABLE IF EXISTS `npca_active_data`;
CREATE TABLE `npca_active_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `master_player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `challenge_result` tinyint(50) NULL DEFAULT NULL,
  `challenge_time` bigint(50) NULL DEFAULT NULL,
  `slave_award_state` tinyint(50) NULL DEFAULT 0,
  `state` tinyint(11) NULL DEFAULT 0,
  `slave_win_state` tinyint(50) NULL DEFAULT 0,
  `succeed_data` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `defeated` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`player_id`) USING BTREE,
  INDEX `kind`(`challenge_result`) USING BTREE,
  INDEX `name`(`challenge_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for npca_active_slave_data
-- ----------------------------
DROP TABLE IF EXISTS `npca_active_slave_data`;
CREATE TABLE `npca_active_slave_data`  (
  `master_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `challenge_result` tinyint(11) NULL DEFAULT NULL,
  `challenge_time` bigint(50) NULL DEFAULT NULL,
  PRIMARY KEY (`master_id`, `player_id`) USING BTREE,
  INDEX `index2`(`challenge_result`) USING BTREE,
  INDEX `kind`(`challenge_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for npca_active_wallet_log
-- ----------------------------
DROP TABLE IF EXISTS `npca_active_wallet_log`;
CREATE TABLE `npca_active_wallet_log`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `type` tinyint(50) NULL DEFAULT NULL,
  `value` int(50) NULL DEFAULT NULL,
  `time` bigint(50) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index2`(`id`) USING BTREE,
  INDEX `kind`(`type`) USING BTREE,
  INDEX `name`(`value`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3249 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 979956839 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家财物日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_block_status_log`  (
  ...
  `op_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '操作人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 250 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_buyu_rank_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4585 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_dress_info_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 90298 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_jika_data
-- ----------------------------
DROP TABLE IF EXISTS `player_jika_data`;
CREATE TABLE `player_jika_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `buy_time` bigint(50) NULL DEFAULT NULL COMMENT '购买时间',
  `total_remain_num` int(50) NULL DEFAULT NULL COMMENT '剩余次数',
  `is_lottery` tinyint(5) NULL DEFAULT NULL COMMENT '领取状态，未领取0，已领取1',
  `last_lottery_time` bigint(20) NULL DEFAULT NULL COMMENT '上一次处理抽奖时间',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for player_jika_lottery_log
-- ----------------------------
DROP TABLE IF EXISTS `player_jika_lottery_log`;
CREATE TABLE `player_jika_lottery_log`  (
  `log_id` int(50) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '玩家id',
  `award_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '奖励名',
  `award_id` int(10) NULL DEFAULT NULL COMMENT '奖励id',
  `award_value` int(50) NULL DEFAULT NULL COMMENT '奖励数量',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25094 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_login_benefits_data
-- ----------------------------
DROP TABLE IF EXISTS `player_login_benefits_data`;
CREATE TABLE `player_login_benefits_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `buy_time` bigint(50) NULL DEFAULT NULL COMMENT '购买时间',
  `total_remain_num` int(50) NULL DEFAULT NULL COMMENT '剩余次数',
  `is_receive` tinyint(5) NULL DEFAULT NULL COMMENT '使用状态 0未使用 1使用',
  `login_day` int(10) NULL DEFAULT NULL COMMENT '连续登录天数',
  `last_use_time` bigint(20) NULL DEFAULT NULL COMMENT '上一次使用时间',
  `lottery_num` int(20) NULL DEFAULT NULL COMMENT '抽奖次数',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_login_log`  (
  ...
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 104770641 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '登录日志表\r\n' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6209409 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_new_vip_data`  (
  ...
  `treasure_value` int(50) NULL DEFAULT 0 COMMENT '财富值(vip11-12的升级凭据)',
  `add_gift_remain_treasure_value` int(50) NULL DEFAULT 0 COMMENT '增加领取至尊礼包剩余次数的财富值',
  `vip_gift_remain` int(50) NULL DEFAULT 0 COMMENT 'vip11-12的至尊礼包的剩余次数',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_new_yueka_data
-- ----------------------------
DROP TABLE IF EXISTS `player_new_yueka_data`;
CREATE TABLE `player_new_yueka_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `buy_time_1` bigint(50) NULL DEFAULT NULL COMMENT '月卡1购买时间',
  `total_remain_num_1` int(50) NULL DEFAULT NULL COMMENT '月卡1剩余次数',
  `is_receive_1` tinyint(5) NULL DEFAULT NULL COMMENT '月卡1使用状态 0未使用 1使用',
  `last_use_yueka_1` bigint(20) NULL DEFAULT NULL COMMENT '上一次使用月卡1时间',
  `buy_time_2` bigint(50) NULL DEFAULT NULL COMMENT '月卡1购买时间',
  `total_remain_num_2` int(50) NULL DEFAULT NULL COMMENT '月卡2剩余次数',
  `is_receive_2` tinyint(5) NULL DEFAULT NULL COMMENT '月卡2使用状态 0未使用 1使用',
  `last_use_yueka_2` bigint(50) NULL DEFAULT NULL COMMENT '上一次使用月卡2时间',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_object_log`  (
  ...
  `change_way_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2933677 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_openinstall_tuiguan_data
-- ----------------------------
DROP TABLE IF EXISTS `player_openinstall_tuiguan_data`;
CREATE TABLE `player_openinstall_tuiguan_data`  (
  `player_id` bigint(50) NOT NULL,
  `is_set_head_image` int(10) NULL DEFAULT NULL COMMENT '是否已经设置了头像，0没有，1已设',
  `udpate_name_num` int(10) NULL DEFAULT NULL COMMENT '修改名字的次数'
...
-- ----------------------------
-- Table structure for player_pay_limit
-- ----------------------------
DROP TABLE IF EXISTS `player_pay_limit`;
CREATE TABLE `player_pay_limit`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `cur_day` int(11) NOT NULL COMMENT '天序号，相对： 2020-1-1 4:0:0',
  `cur_sum` bigint(20) NULL DEFAULT NULL COMMENT '今天累积支付',
  `pay_limit` bigint(20) NULL DEFAULT NULL COMMENT '支付限额',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_pay_order_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1914435 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '玩家充值订单详情表\r\n\r\n订单中的每个购买项' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_pay_order_detail_log`  (
  ...
  `goods_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'buy' COMMENT '商品类型： \"buy\",\"gift\"',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2642521 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '玩家充值订单详情表\r\n\r\n订单中的每个购买项' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 34552050 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '玩家道具日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_rank_award_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11693 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_rank_data`  (
  `data_id` int(50) NOT NULL COMMENT '数据id',
  ...
  `other_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '其他数据的字符串',
  PRIMARY KEY (`data_id`, `rank_type`) USING BTREE,
...
CREATE TABLE `player_rank_log`  (
  ...
  `score` bigint(50) NULL DEFAULT NULL COMMENT '分数',
  `other_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '其他数据',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11708 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for player_recall_children_data
-- ----------------------------
DROP TABLE IF EXISTS `player_recall_children_data`;
CREATE TABLE `player_recall_children_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `children_id_str` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '满足条件的下级id,逗号分隔',
  `is_recall_str` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '是否召回(0没有，1召回) 0,1组成的 ',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3052034 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_statis_profit_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6466999 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_tantanle_log
-- ----------------------------
DROP TABLE IF EXISTS `player_tantanle_log`;
CREATE TABLE `player_tantanle_log`  (
  `id` int(50) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '玩家id',
  `angle` int(11) NULL DEFAULT NULL,
  `total_bet_money` int(50) NULL DEFAULT NULL COMMENT '竞猜的单线总金额',
  `bet_money` int(50) NULL DEFAULT NULL COMMENT '竞猜的单线总金额',
  `kaijiang_beishu` float(50, 2) NULL DEFAULT NULL COMMENT '开奖的总倍数(原始单线倍数)',
  `random_beishu` float(50, 2) NULL DEFAULT NULL COMMENT '开奖的随机倍数',
  ...
  `cfg_pos_index` mediumint(50) NULL DEFAULT NULL COMMENT '开奖索引',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '开奖时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `player_id`(`player_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 378030 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_task`  (
  ...
  `task_award_get_status` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '任务奖励的领取状态',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7371288 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 255609277 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_verify_log`  (
  ...
  `op_user` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注，记录此次操作的说明',
  ...
  PRIMARY KEY (`log_id`) USING BTREE,
  INDEX `index2`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '登录验证日志表： 删除、启用验证信息的 日志\r\n' ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xiaoxiaole_caishen_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '开奖时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3174843 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xiaoxiaole_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 73544408 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xiaoxiaole_shuihu_log`  (
  ...
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42818111 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xuyuanchi_award_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 562449 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for player_xuyuanchi_exclude_profit_data
-- ----------------------------
DROP TABLE IF EXISTS `player_xuyuanchi_exclude_profit_data`;
CREATE TABLE `player_xuyuanchi_exclude_profit_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `exclude_profit` bigint(50) NULL DEFAULT NULL COMMENT '要排除掉的赢亏值',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for player_xuyuanchi_exclude_profit_log
-- ----------------------------
DROP TABLE IF EXISTS `player_xuyuanchi_exclude_profit_log`;
CREATE TABLE `player_xuyuanchi_exclude_profit_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '玩家id',
  `exclude_profit` bigint(50) NULL DEFAULT NULL COMMENT '需要排除的盈亏值',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 327730 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xuyuanchi_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 167254 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_xuyuanchi_sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 300 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `player_zajindan_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9524824 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 47039 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `redeem_code_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 110970 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `sczd_achievement_sys_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 76549 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `sczd_change_parent_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1007558 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 123052 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `sczd_player_day_achievements_log`  (
  ...
  PRIMARY KEY (`no`) USING BTREE,
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 797291 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_buried_point`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2274419 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_buried_point_ad_everyday_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1157 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_buried_point_log`  (
  ...
  `time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3333259 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_player_game_info`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `join_qys_num` int(50) NULL DEFAULT 0 COMMENT '参加千元赛的次数',
  `web_store_exchange_2_hongbao` int(50) NULL DEFAULT 0 COMMENT '兑换web商城的2元红包的次数',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_player_leijiyingjin_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '玩家id',
  `sh_xxl_spend` bigint(50) NULL DEFAULT 0 COMMENT '水浒消消乐累积花费',
  `sh_xxl_award` bigint(50) NULL DEFAULT 0 COMMENT '水浒消消乐累积赢金',
  `xxl_spend` bigint(50) NULL DEFAULT 0 COMMENT '消消乐累积花费',
  `xxl_award` bigint(50) NULL DEFAULT 0 COMMENT '消消乐累积赢金',
  `cs_xxl_spend` bigint(50) NULL DEFAULT 0 COMMENT '财神消消乐累积花费',
  `cs_xxl_award` bigint(50) NULL DEFAULT 0 COMMENT '财神消消乐累积赢金',
  `buyu_spend` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼花费',
  `buyu_award` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼赢金',
  `buyu_3d_spend` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼3d花费',
  `buyu_3d_award` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼3d赢金',
  `bykp_spend` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼快跑(疯狂捕鱼)花费',
  `bykp_award` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼快跑(疯狂捕鱼)赢金',
  `zajindan_spend` bigint(50) NULL DEFAULT 0 COMMENT '砸金蛋花费',
  `zajindan_award` bigint(50) NULL DEFAULT 0 COMMENT '砸金蛋赢金',
  `lhd_spend` bigint(50) NULL DEFAULT 0 COMMENT '金蛋大乱斗累积花费',
  `lhd_award` bigint(50) NULL DEFAULT 0 COMMENT '金蛋大乱斗累积赢金',
  `freestyle_game_spend` bigint(50) NULL DEFAULT 0 COMMENT '自由场花费',
  `freestyle_game_award` bigint(50) NULL DEFAULT 0 COMMENT '自由场赢金',
  `tantanle_spend` bigint(50) NULL DEFAULT 0 COMMENT '弹弹乐花费',
  `tantanle_award` bigint(50) NULL DEFAULT 0 COMMENT '弹弹乐赢金',
  `zijianfang_spend` bigint(50) NULL DEFAULT 0 COMMENT '自建房花费',
  `zijianfang_award` bigint(50) NULL DEFAULT 0 COMMENT '自建房赢金',
  `guess_apple_spend` bigint(50) NULL DEFAULT 0 COMMENT '种苹果花费',
  `guess_apple_award` bigint(50) NULL DEFAULT 0 COMMENT '种苹果赢金',
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_player_leijiyingjin_log`  (
  ...
  `buyu_spend` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼花费',
  `buyu_award` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼赢金',
  `buyu_3d_spend` bigint(50) NULL DEFAULT NULL COMMENT '捕鱼3d花费',
  `buyu_3d_award` bigint(50) NULL DEFAULT NULL COMMENT '捕鱼3d赢金',
  `bykp_spend` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼快跑(疯狂捕鱼)花费',
  `bykp_award` bigint(50) NULL DEFAULT 0 COMMENT '捕鱼快跑(疯狂捕鱼)赢金',
  `zajindan_spend` bigint(50) NULL DEFAULT 0 COMMENT '砸金蛋花费',
  `zajindan_award` bigint(50) NULL DEFAULT 0 COMMENT '砸金蛋赢金',
  ...
  `guess_apple_spend` bigint(50) NULL DEFAULT 0 COMMENT '种苹果花费',
  `guess_apple_award` bigint(50) NULL DEFAULT 0 COMMENT '种苹果赢金',
  `total_spend` bigint(50) NULL DEFAULT NULL COMMENT '总花费',
  `total_award` bigint(50) NULL DEFAULT NULL COMMENT '总赢金',
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2180462 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 220291 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_player_tag_log`  (
  ...
  `time` datetime(0) NULL DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1723104 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_player_watch_ad`  (
  ...
  INDEX `ID_UNIQUE`(`id`) USING BTREE,
  INDEX `xz`(`player_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1537880 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `statistics_system_realtime`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2162944 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '实时统计数据' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for tel_bill_data
-- ----------------------------
DROP TABLE IF EXISTS `tel_bill_data`;
CREATE TABLE `tel_bill_data`  (
  `player_id` int(255) NOT NULL COMMENT ' 用户id',
  `start_time` int(255) NULL DEFAULT NULL COMMENT '开始时间',
  `day_s` int(255) NULL DEFAULT NULL COMMENT '每一天的签到情况，1为已签，2为补签，0为未签',
  `exchange` int(255) NULL DEFAULT NULL COMMENT '是否兑换20话费，1为已兑换',
  PRIMARY KEY (`player_id`) USING BTREE,
  UNIQUE INDEX `player_id`(`player_id`) USING BTREE COMMENT '用户id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for test_user_list
-- ----------------------------
DROP TABLE IF EXISTS `test_user_list`;
CREATE TABLE `test_user_list`  (
  `id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '玩家id',
  `real_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `op_date` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `xiaoxiaole_once_game_award_log`  (
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3701 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for xiaoxiaole_shuihu_once_game_award_log
-- ----------------------------
DROP TABLE IF EXISTS `xiaoxiaole_shuihu_once_game_award_log`;
CREATE TABLE `xiaoxiaole_shuihu_once_game_award_log`  (
  `id` int(50) NOT NULL AUTO_INCREMENT,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '玩家id',
  `bet_money` int(50) NULL DEFAULT NULL COMMENT '下注金额',
  `award_money` int(50) NULL DEFAULT NULL COMMENT '奖励金额',
  ...
  `time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 801 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for xiaoxiaole_shuihu_once_game_data
-- ----------------------------
DROP TABLE IF EXISTS `xiaoxiaole_shuihu_once_game_data`;
CREATE TABLE `xiaoxiaole_shuihu_once_game_data`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '玩家id',
  `bet_money` int(50) NULL DEFAULT NULL COMMENT '下注金额',
  `award_money` int(255) NULL DEFAULT NULL COMMENT '最大的开奖金额',
  `time` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for xiaoxiaole_shuihu_once_game_rank_data
-- ----------------------------
DROP TABLE IF EXISTS `xiaoxiaole_shuihu_once_game_rank_data`;
CREATE TABLE `xiaoxiaole_shuihu_once_game_rank_data`  (
  `id` int(50) NOT NULL,
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '玩家id',
  `bet_money` int(50) NULL DEFAULT NULL COMMENT '下注金额',
  `award_money` int(50) NULL DEFAULT NULL COMMENT '奖励金额',
...
-- ----------------------------
-- Table structure for zijianfang_history_record
-- ----------------------------
DROP TABLE IF EXISTS `zijianfang_history_record`;
CREATE TABLE `zijianfang_history_record`  (
  `id` int(10) UNSIGNED NOT NULL COMMENT '对局id，自增长主键',
  `race_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '对局id',
  `room_no` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '房间编号',
  `game_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '游戏类型',
  `game_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '游戏名',
  `room_owner` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '房主',
  `room_rent` int(255) NULL DEFAULT NULL COMMENT '房费',
  `room_options` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '房间规则',
  `begin_time` bigint(20) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` bigint(20) NULL DEFAULT 0 COMMENT '结束时间',
  `over_reason` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '结束原因',
  `fangzhu_pay` int(5) NULL DEFAULT NULL COMMENT '是否房主包',
  `p1_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `p1_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `p1_head_img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `p1_score` int(20) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ID_UNIQUE`(`id`) USING BTREE,
  INDEX `time`(`end_time`) USING BTREE,
  INDEX `p1_id`(`p1_id`) USING BTREE,
  INDEX `p2_id`(`p2_id`) USING BTREE,
  INDEX `p3_id`(`p3_id`) USING BTREE,
  INDEX `p4_id`(`p4_id`) USING BTREE
...
-- ----------------------------
-- Table structure for zijianfang_player_history
-- ----------------------------
DROP TABLE IF EXISTS `zijianfang_player_history`;
CREATE TABLE `zijianfang_player_history`  (
  `player_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '10111111111，ID由11位数字组成，前两位表示服务器号',
  `record_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'zijianfang_history_record中的id以逗号分割',
  PRIMARY KEY (`player_id`, `record_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for zijianfang_room_options_log
-- ----------------------------
DROP TABLE IF EXISTS `zijianfang_room_options_log`;
CREATE TABLE `zijianfang_room_options_log`  (
  `md5_key` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `room_options` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`md5_key`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- View structure for player_shop_order_all
-- ----------------------------
DROP VIEW IF EXISTS `player_shop_order_all`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `player_shop_order_all` AS select `player_shop_order`.`order_id` AS `order_id`,`player_shop_order`.`player_id` AS `player_id`,`player_shop_order`.`order_status` AS `order_status`,`player_shop_order`.`amount` AS `amount`,`player_shop_order`.`props_json` AS `props_json`,`player_shop_order`.`shoping_desc` AS `shoping_desc`,`player_shop_order`.`shoping_time` AS `shoping_time`,`player_shop_order`.`refund_time` AS `refund_time`,`player_shop_order`.`goods_id` AS `goods_id`,`player_shop_order`.`authflags_json` AS `authflags_json`,`player_shop_order`.`actual_amount` AS `actual_amount` from `player_shop_order` union all select `player_shop_order_log`.`order_id` AS `order_id`,`player_shop_order_log`.`player_id` AS `player_id`,`player_shop_order_log`.`order_status` AS `order_status`,`player_shop_order_log`.`amount` AS `amount`,`player_shop_order_log`.`props_json` AS `props_json`,`player_shop_order_log`.`shoping_desc` AS `shoping_desc`,`player_shop_order_log`.`shoping_time` AS `shoping_time`,`player_shop_order_log`.`refund_time` AS `refund_time`,`player_shop_order_log`.`goods_id` AS `goods_id`,`player_shop_order_log`.`authflags_json` AS `authflags_json`,`player_shop_order_log`.`actual_amount` AS `actual_amount` from `player_shop_order_log`;
...
BEGIN
#call clear_his_data_batch(20000,200)
	declare i int;
	
	set i=0;
	while i < batch_count do
		call clear_his_data('2020-02-06 0:0:0',clear_count);
		set i=i+1;
...
BEGIN
    ...
    insert into player_withdraw_log(withdraw_id,player_id,withdraw_status,error_desc,money,src_type,asset_type,channel_type,channel_withdraw_id,channel_receiver_id,create_time,complete_time,`comment`)
    select withdraw_id,player_id,withdraw_status,error_desc,money,src_type,asset_type,channel_type,channel_withdraw_id,channel_receiver_id,create_time,complete_time,`comment` from player_withdraw where (withdraw_status='complete' and complete_time < last_day) or (withdraw_status<>'complete' and complete_time < last_week);
...
BEGIN
	...
	select count(*) into _count from exec_sql_info where proc_id=connection_id();
	# 只保留 n 条
	if _count > 20 then
			PREPARE s1 FROM 'delete from exec_sql_info where proc_id = connection_id() order by dur limit ?';
			set @del_c = _count - 20;  
			EXECUTE s1 USING @del_c;
	end if;
END
;;
delimiter ;
...
delimiter ;;
CREATE PROCEDURE `get_sczd_all_son_main_info`(IN _player_id VARCHAR(50) , IN _max_show_son_num int)
  SQL SECURITY INVOKER
BEGIN
  #Routine body goes here...
	select 
		...
		ifnull( (select count(*) from sczd_income_deatails_log where player_id = a.id and parent_id = _player_id and treasure_type = 151 limit 1) , 0) as bisai_contribution_num ,
		...
		ifnull( (select count(*) from sczd_income_deatails_log where player_id = a.id and parent_id = _player_id and treasure_type = 200 limit 1) , 0) as web_store_exchange_2_hongbao_num ,
		...
		where a.id in (select id from sczd_relation_data where parent_id = _player_id) limit _max_show_son_num;
...
CREATE PROCEDURE `get_sczd_base_info`(IN _player_id varchar(50) 
	...
	, out bisai_contribution_num int
	, out goldpig_lb1_contribution_num int
	, out goldpig_lb2_contribution_num int
	, out vip_lb_contribution_num int
	, out is_buy_all_return_bag_1 TINYINT
	, out is_buy_all_return_bag_2 TINYINT
	, out is_buy_all_return_bag_3 TINYINT
	, out _web_store_exchange_2_hongbao int
	, out _web_store_exchange_2_hongbao_num int)
  SQL SECURITY INVOKER
BEGIN
	#Routine body goes here...
	...
	declare m_parent_id VARCHAR(255) DEFAULT '';
	...
	set _web_store_exchange_2_hongbao = IFNULL( (select web_store_exchange_2_hongbao from statistics_player_game_info where player_id = _player_id),0);
	...
	select parent_id into m_parent_id from sczd_relation_data where id = _player_id;

	select ifnull( count(*) , 0 ) into bisai_contribution_num from sczd_income_deatails_log where player_id = _player_id and parent_id = m_parent_id and treasure_type = 151 limit 1;
	select ifnull( count(*) , 0 ) into goldpig_lb1_contribution_num from sczd_income_deatails_log where player_id = _player_id and parent_id = m_parent_id and treasure_type = 101 limit 1;
	select ifnull( count(*) , 0 ) into goldpig_lb2_contribution_num from sczd_income_deatails_log where player_id = _player_id and parent_id = m_parent_id and treasure_type = 102 limit 1;
	select ifnull( count(*) , 0 ) into vip_lb_contribution_num from sczd_income_deatails_log where player_id = _player_id and parent_id = m_parent_id and treasure_type = 103 limit 1;
	select ifnull(count(*) , 0) into _web_store_exchange_2_hongbao_num from sczd_income_deatails_log where player_id = _player_id and parent_id = m_parent_id and treasure_type = 200 limit 1;
	select ifnull( (select is_buy from sczd_all_return_lb_data where player_id = _player_id and all_return_bag_type = 'all_return_lb_1') , 0) into is_buy_all_return_bag_1 ;
	select ifnull( (select is_buy from sczd_all_return_lb_data where player_id = _player_id and all_return_bag_type = 'all_return_lb_2') , 0) into is_buy_all_return_bag_2 ;
	select ifnull( (select is_buy from sczd_all_return_lb_data where player_id = _player_id and all_return_bag_type = 'all_return_lb_3') , 0) into is_buy_all_return_bag_3 ;
...
BEGIN
  ...
  on duplicate key update login_ip = login_ip,login_os=login_os,log_id = last_insert_id(),on_line=1,login_time = now(),logout_time=null;
	...
	insert into player_login_stat(id,first_login_time,first_log_id,last_login_time,last_log_id) values(_id,now(),last_insert_id(),null,last_insert_id())
  on duplicate key update last_log_id=last_insert_id();
...
delimiter ;;
CREATE PROCEDURE `sp_logout`(_ID varchar(50),_login_time datetime)
  SQL SECURITY INVOKER
BEGIN
    declare _log_id INT;
    ...
    if FOUND_ROWS() > 0 then
		...
		update player_login_stat set last_login_time = _login_time where id = _ID;
	end if;
...
BEGIN
	...
	# 用现在的资产数据 减去 player_last_asset_map 昨天记录的资产表的数据(第一次没有数据，则是当前资产数据) ，插入到player_statis_profit_log表中
	...
	# 将当前的资产数据写入 player_last_asset_map 表中
